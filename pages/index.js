    ...
    <Container>
      ...
      <Section delay={0.1}>
        ...
        <Paragraph>
          ...
          While at Google, my publicly facing research (done in collaboration with the University of California, Berkeley) has been mentioned/featured across blogs (i.e., <Link as={NextLink} href="https://deepmind.google/blog/alphaevolve-impact/" passHref {...externalLinkProps}>Google DeepMind AlphaEvolve</Link>, <Link as={NextLink} href="https://antigravity.google/blog/teamwork-when-ai-becomes-a-research-partner" passHref {...externalLinkProps}>Google Antigravity</Link>, and <Link as={NextLink} href="https://www.sigarch.org/architecture-systems-are-changing-the-architects-role-in-the-era-of-agentic-co-design/" passHref {...externalLinkProps}>ACM SIGARCH</Link> blogs), podcasts (i.e., the <Link as={NextLink} href="https://comparchpodcast.podbean.com/e/ep-24-from-unicorns-to-centaurs-co-designing-computer-systems-for-the-ai-era-with-dr-partha-ranganathan-google/" passHref {...externalLinkProps}>Computer Architecture Podcast</Link>), keynotes (i.e., <Link as={NextLink} href="https://dl.acm.org/doi/10.1145/3779212.3795611" passHref {...externalLinkProps}>ASPLOS 2026 keynote by Engineering Fellow/VP Partha Ranganathan</Link>), and published (i.e., <Link href="#publications">ArXiv publications</Link>).
