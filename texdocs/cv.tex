...
\item Publicly facing research, done in collaboration with the University of California, Berkeley, has been mentioned or featured across blogs (i.e., \href{https://deepmind.google/blog/alphaevolve-impact/}{Google DeepMind AlphaEvolve}, \href{https://antigravity.google/blog/teamwork-when-ai-becomes-a-research-partner}{Google Antigravity}, and \href{https://www.sigarch.org/architecture-systems-are-changing-the-architects-role-in-the-era-of-agentic-co-design/}{ACM SIGARCH} blogs), podcasts (i.e., the \href{https://comparchpodcast.podbean.com/e/ep-24-from-unicorns-to-centaurs-co-designing-computer-systems-for-the-ai-era-with-dr-partha-ranganathan-google/}{Computer Architecture Podcast}), keynotes (i.e., \href{https://dl.acm.org/doi/10.1145/3779212.3795611}{ASPLOS 2026 keynote by Engineering Fellow and Vice President Partha Ranganathan}), and \hyperref[sec:pubs]{published work}.
\item Lead organizer of the MICRO 2026 \hyperref[sec:tutorialsworkshops]{A\textsuperscript{3}: Agentic Approaches to Architecture Workshop} and \hyperref[sec:tutorialsworkshops]{CHIA Hackathon} and organizer of the ICLAD 2026 \hyperref[sec:tutorialsworkshops]{GenAI Chip Hackathon}.
\end{itemize}
...
\section{\Large{Conference, Journal, Workshop, arXiv, and Technical Report Publications}}
\phantomsection
\label{sec:pubs}
\vspace{2mm}
...
\\
\underline{arXiv '26}, arXiv '26, ISCA '24, \underline{ISCA '23}, \underline{ESSCIRC '21}, ISPASS '21, \underline{DAC '20 (invited)}, \underline{IEEE Micro 2020.4}, CARRV '20,\\
\underline{UC Berkeley Technical Report '20}, \underline{CARRV '19}
\vspace{-0.8mm}

\textbf{ArchAgent v2: A Case Study with the Data Prefetching Championship} \hfill arXiv '26
\vspace{0.7mm}
\\
\href{https://arxiv.org/abs/2608.09874}{\underline{Abraham Gonzalez}, Raghav Gupta, Akanksha Jain, Hanna Alam, Alexander Novikov, Po-Sen Huang, Matej Balog, Marvin Eisenberger, Sergey Shirobokov, Ng\^an V\~u, Hank Levy, Borivoje Nikoli\'c, Sagar Karandikar, Martin Dixon, and Parthasarathy Ranganathan, ``ArchAgent v2: A Case Study with the Data Prefetching Championship'', \textit{arXiv preprint arXiv:2608.09874}, August 2026.}
\vspace{-0.8mm}

\textbf{ArchAgent: Agentic AI-driven Computer Architecture Discovery} \hfill arXiv '26
\vspace{0.7mm}
\\
{\raggedright
\href{https://arxiv.org/abs/2602.22425}{Raghav Gupta, Akanksha Jain, \underline{Abraham Gonzalez}, Alexander Novikov, Po-Sen Huang, Matej Balog, Marvin Eisenberger, Sergey Shirobokov, Ng\^an V\~u, Martin Dixon, Borivoje Nikoli\'c, Parthasarathy Ranganathan, and Sagar~Karandikar, ``ArchAgent: Agentic AI-driven Computer Architecture Discovery'', \textit{arXiv preprint arXiv:2602.22425}, February 2026.}
\par}
\vspace{-1.5mm}
...
\section{\Large{Workshops, Tutorials, and Hackathons Organized}}
\phantomsection
\label{sec:tutorialsworkshops}
\vspace{2mm}

\textbf{A\textsuperscript{3}: Agentic Approaches to Architecture Workshop and CHIA Hackathon}
\\
\href{https://agentic-arch.org/index.html}{MICRO '26}
\vspace{0.5mm}
\\
Organizer of both the workshop focused on agentic approaches to computer architecture and its corresponding hackathon, co-located with MICRO 2026, jointly organized by Google/Google DeepMind, UC Berkeley, Carnegie Mellon University, and NVIDIA, with sponsorship from Google and NVIDIA.

\textbf{GenAI Chip Hackathon}
\\
\href{https://iclad.ai/lad25-hackathon}{ICLAD-DAC '26}
\vspace{0.5mm}
\\
Organizer of the hackathon focused on using generative AI for chip design tasks, jointly organized by Google, NVIDIA, Qualcomm, NXP, and Arizona State University, with sponsorship from Qualcomm and Google.
