...
\address{\href{https://abejgonzalez.github.io}{https://abejgonzalez.github.io} $|$ \href{mailto:abegonzalez@google.com}{abegonzalez@google.com}}
...
\vspace{-3mm}
\begin{itemize}
\item Software engineer working in the \href{https://techsysinfra.google/research/}{AI and Systems Research} group led by \href{https://techsysinfra.google/research/srg-staff/hank-levy/}{Hank Levy}.
\end{itemize}
...
\textbf{A\textsuperscript{3}: Agentic Approaches to Architecture}
\\
\href{https://agentic-arch.org/index.html}{MICRO '26}
\vspace{0.5mm}
\\
Organizer of the first international workshop on agentic approaches to computer architecture, co-located with MICRO 2026, jointly organized by Google/Google DeepMind, UC Berkeley, Carnegie Mellon University, and NVIDIA, with sponsorship from Google and NVIDIA.
