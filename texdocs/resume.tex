...
\vspace{-3mm}
\begin{itemize}
\item Worked on debugging tools and infrastructure for the microcontroller and firmware teams with senior engineers.
\end{itemize}
...
\vspace{-3mm}
\begin{itemize}
\item Designed a framework and GUI for smartcard (UIM) interaction in C++/CLI and C++ with senior engineers.
\end{itemize}
